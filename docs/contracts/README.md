...
| ASC-0005 | hive-capability-bridge | accepted | Add hivemind/hivemind/capability_bridge.py mirroring memory_bridge.py — calls CapabilityOS recommend during route phase, optional and non-blocking. |
