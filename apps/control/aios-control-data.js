window.AIOS_CONTROL_SNAPSHOT = {
  ...
  "dispatches": {
    ...
    "latest": [
      {
        ...
        "dispatch_id": "asc-0044",
        "goal": "Provide a non-web native desktop AIOS control app for local monitor, contract, dispatch, repo, and route state.",
        "reason": "asc_0044_desktop_control_application_verified",
        "sent": [
          "myworld"
        ],
        "status": "released",
        "timestamp": "2026-05-12T19:28:03+09:00"
      },
      {
        "collected": [
          "myworld"
      ...
      },
      {
        ...
        "dispatch_id": "asc-0041",
        "goal": "Turn validated web evidence receipts into MemoryOS draft review candidates without auto-accepting web-derived facts.",
        "reason": "asc_0041_web_evidence_memory_review_verified",
        "sent": [
          "myworld"
        ],
        "status": "released",
    ...
    "timeline": [
      ...
      },
      {
        ...
        "repo": null,
        "status": "created",
        "timestamp": "2026-05-12T18:50:15+09:00"
      },
      {
        "dispatch_id": "asc-0041",
        "event": "escalated",
      ...
      },
      {
        ...
        "repo": "myworld",
        "status": "escalated",
        "timestamp": "2026-05-12T18:53:10+09:00"
      },
      {
        "dispatch_id": "asc-0041",
        "event": "sent",
        "repo": "myworld",
        "status": "sent",
        "timestamp": "2026-05-12T18:54:26+09:00"
      },
      {
        "dispatch_id": "asc-0041",
        "event": "running",
      ...
      },
      {
        ...
        "repo": "myworld",
        "status": "collected",
        "timestamp": "2026-05-12T18:54:36+09:00"
      },
      {
        "dispatch_id": "asc-0041",
        "event": "released",
      ...
      },
      {
        ...
        "repo": null,
        "status": "created",
        "timestamp": "2026-05-12T19:27:52+09:00"
      },
      {
        "dispatch_id": "asc-0044",
        "event": "sent",
  ...
  "monitor": {
    ...
    "snapshot_generated_at": "2026-05-12T19:28:22+09:00",
    "watched": {
      "alerts": 0,
      "contracts": 44,
      "dispatches": 37,
  ...
  "round_controller": {
    ...
    "failed_steps": [],
    "generated_at": "2026-05-12T19:27:53+09:00",
    "mode": "control_only",
    "recommended_next": {
    ...
    "steps": {
      "dispatch_loop": {
        ...
        "parsed": {
          "actions": [],
          "generated_at": "2026-05-12T19:27:52+09:00",
          "mode": "apply",
          "observations": [
            {
      ...
      "goal_evolution": {
        ...
        "parsed": {
          "evidence": {
            ...
            "policy_generated_at": "2026-05-12T19:27:51+09:00",
            "radar_candidate_count": 60,
            "readiness_level": 6,
            "readiness_level_name": "L6 repeatable"
          },
          "generated_at": "2026-05-12T19:27:51+09:00",
          "goal": {
            "anti_cheat_checks": [
      ...
      "monitor": {
        ...
        "parsed": {
          ...
          "schema_version": "aios.monitor.assessment.v1",
          "snapshot_generated_at": "2026-05-12T19:27:51+09:00",
          "watched": {
            "alerts": 0,
            "contracts": 44,
            "dispatches": 36,
    ...
    "items": [
      {
        ...
        "name": "`absolute_or_raw_private_ref`"
      },
      {
        "contracts": [
          "ASC-0043"
      ...
      },
      {
        ...
        "name": "`candidate_without_provenance`"
      },
      {
        "contracts": [
          "ASC-0038"
